...
from api_test_crew.tools.custom_tool import HttpExecutorTool
...
class ApiTestCrew():
    ...
    def task_exec(self) -> Task:
        return Task(
            config=self.tasks_config['task_exec'], # type: ignore[index]
        )
